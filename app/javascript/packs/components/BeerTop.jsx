    ...
    <>
      <div className="wrapper beer">
        ...
        <div id="select-beer-genre">
          <a href="/beers?category=lager" className="beer-genre" id="lager">
            <p style={{ color: "#000" }}>
          ...
          <a href="/beers?category=ale" className="beer-genre" id="ale">
            <p style={{ color: "#FFF" }}>
          ...
          <a href="/beers?category=others" className="beer-genre" id="others">
            <p style={{ color: "#000" }}>
